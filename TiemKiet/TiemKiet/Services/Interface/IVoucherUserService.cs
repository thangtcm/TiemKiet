...
namespace TiemKiet.Services.Interface
{
    ...
    {
        public Task<ICollection<VoucherUser>> GetListAsync();
        ...
        public Task<StatusResponse<VoucherUser>> ReceiveVoucher(string VoucherCode, long UserId);
        public Task<bool> Add(VoucherUser model);
